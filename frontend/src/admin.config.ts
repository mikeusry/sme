...
export const DEFAULT_NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Orders', href: '/admin/orders', icon: 'shopping-bag' }, // No module - always shown
  ...
  { label: 'Social Guide', href: '/admin/social', icon: 'share', module: 'socialGuide' },
  { label: 'Components Demo', href: '/demo/pickup-scheduling', icon: 'grid' }, // Dev tools
];
