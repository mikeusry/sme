...
const PRODUCT_CATALOG = {
  ...
  'humus-compost': {
    ...
    seo: {
      title: 'Regenerative Organic Compost Athens GA | Soul Miner\'s Eden',
      description: 'Georgia\'s only regenerative organic compost. Premium humus compost for healthier soil and thriving plants. Local delivery available.',
      keywords: ['organic compost', 'regenerative compost Athens GA', 'humus compost', 'soil amendment', 'garden compost Georgia']
    }
  },
  ...
  'compost-blend': {
    ...
    longDescription: 'Our custom topsoil-compost blend combines the structure of quality topsoil with the nutrition of regenerative organic compost. This ready-to-plant mix is perfect for raised beds, container gardens, and new garden installations.',
    price: 40,
    unit: 'cubic yard',
    sku: 'SME-SPEC-002',
    inStock: true,
    ...
    benefits: [
      ...
      'Contains regenerative organic compost'
    ],
    applications: [
      'Raised bed gardens',
      'Container gardens',
    ...
    seo: {
      ...
      description: 'Ready-to-plant blend of topsoil and regenerative organic compost. Perfect for raised beds and vegetable gardens.',
